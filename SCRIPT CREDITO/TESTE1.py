...
def getCredito(exercicio: int, totalRegistroPagina=5000):
    """
    ...
    try:
        ...
        while True:
            ...
            if resposta.status_code == 200:
                ...
                if resposta_dado.get("registros"):
                    ...
                    pagina += 1  # Incrementa a página para a próxima solicitação
                else:
                    # Não há mais páginas, termina o loop
                    break
